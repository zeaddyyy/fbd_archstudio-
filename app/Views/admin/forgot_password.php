...
<head>
    ...
    <title>Forgot Password | FB Design Studio</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-link a:hover { color: #1a1a1a; text-decoration: underline; }
...
<body>
    <div class="container">
        <div class="card">
            <div class="brand">
                <div class="brand-icon"><i class="ri-key-line"></i></div>
            ...
            <form method="post" action="<?= base_url('admin/send-otp') ?>">
                <?= csrf_field() ?>
                <div class="form-group">
                    <div class="input-group">
                        <i class="ri-mail-line"></i>
                        <input type="email" name="email" placeholder="Registered Email Address" required value="<?= old('email') ?>">
                    </div>
                </div>
                <button type="submit" class="btn"><i class="ri-mail-send-line"></i> Send OTP</button>
            </form>

            <div class="back-link">
                <a href="<?= base_url('admin/login') ?>"><i class="ri-arrow-left-line"></i> Back to Login</a>
            </div>
        </div>
    </div>
</body>
